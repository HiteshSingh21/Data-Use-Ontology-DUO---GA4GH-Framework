...
st.set_page_config(
    page_title="Machine-Verifiable Compliance Bot",
    page_icon="⚖️",
    layout="wide"
)

def display_pdf(file_bytes):
    """Embeds PDF file into Streamlit for side-by-side view."""
    base64_pdf = base64.b64encode(file_bytes).decode('utf-8')
    pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}" width="100%" height="600" type="application/pdf"></iframe>'
    st.markdown(pdf_display, unsafe_allow_html=True)

st.title("⚖️ GA4GH Compliance Verifier")
...
with st.sidebar:
    ...
    st.markdown("Upload base policies (e.g., GA4GH Framework) to update the knowledge base.")
    ...
    if policy_file is not None and st.button("Ingest Policy"):
        with st.spinner("Ingesting policy into FAISS Vector Store..."):
...
# Main application for user workflow
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    with col2:
                        ...
                        # DUO Mapping Section
                        st.markdown("### 🏷️ Machine-Readable DUO Tags")
